/**
 * Types for clawsig external harness adapters.
 *
...
export const ENV = {
  CLAWPROXY_BASE_URL: 'CLAWSIG_PROXY_URL',
  CLAWPROXY_TOKEN: 'CLAWSIG_PROXY_TOKEN',

  // Optional marketplace integration (job-scoped CST auto-fetch)
  CLAWBOUNTIES_BASE_URL: 'CLAWBOUNTIES_BASE_URL',
  CLAWBOUNTIES_BOUNTY_ID: 'CLAWBOUNTIES_BOUNTY_ID',
  CLAWBOUNTIES_WORKER_TOKEN: 'CLAWBOUNTIES_WORKER_TOKEN',

  AGENT_KEY_FILE: 'CLAWSIG_KEY_FILE',
  OUTPUT_DIR: 'CLAWSIG_OUTPUT_DIR',

  // Optional: offline verification post-run (CPL-US-010)
  VERIFY: 'CLAWSIG_VERIFY',
  VERIFY_CONFIG: 'CLAWSIG_VERIFY_CONFIG',
  VERIFY_STRICT: 'CLAWSIG_VERIFY_STRICT',

  HARNESS_ID: 'CLAWSIG_HARNESS_ID',
  HARNESS_VERSION: 'CLAWSIG_HARNESS_VERSION',
} as const;
