...
const scriptPath = path.resolve('scripts/arena/run-outcome-seeder.mjs');

test('outcome seeder dry-run writes preview summary', () => {
  ...
  const marker = lines.find((l) => l.startsWith('ARENA_OUTCOME_SEEDER_RESULT '));
