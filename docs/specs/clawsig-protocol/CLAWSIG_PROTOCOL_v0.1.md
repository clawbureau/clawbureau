...
>
> **Scope:**
> - Define the **narrow waist** for the “Clawsig Protocol”: a tiny set of primitives that can be implemented by third parties.
...
# Clawsig Protocol v0.1 — Narrow Waist
...
- **Tool receipts** (SHIPPED):
  ...
  - SDK: `packages/clawsig-sdk` `ClawproofRun.recordToolCall()`
...
- **Side-effect receipts** (SHIPPED):
  ...
  - SDK: `packages/clawsig-sdk` `ClawproofRun.recordSideEffect()`
...
- **Human approval receipts** (SHIPPED):
  ...
  - SDK: `packages/clawsig-sdk` `ClawproofRun.recordHumanApproval()`
...
**Clawsig Protocol proofs demonstrate:**
...
**Clawsig Protocol proofs do NOT demonstrate:**
...
Execution tracking for Clawsig Protocol lives in:
- `docs/roadmaps/clawsig-protocol/`
