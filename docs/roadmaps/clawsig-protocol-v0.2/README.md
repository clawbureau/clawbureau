...
**Status summary:** v0.2 core is fully shipped on `main`, and the causal attribution hardening tranche is shipped through `CAV-US-021` (merge PR #324).
...
## Causal attribution tranche (shipped through CAV-US-021)
