...
**Status summary:** v0.2 core is fully shipped on `main`, and the causal attribution hardening tranche is shipped through `CAV-US-024` (merge PR #327).
...
## Causal attribution tranche (shipped through CAV-US-024)
