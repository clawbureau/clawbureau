...
1. `docs/roadmaps/proof-of-harness/README.md`
2. `docs/roadmaps/proof-of-harness/ADAPTER_SPEC_v1.md`
3. `docs/roadmaps/proof-of-harness/HARNESS_REGISTRY.md`
4. `docs/roadmaps/trust-vnext/README.md`
5. PRDs:
